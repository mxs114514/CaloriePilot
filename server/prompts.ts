...
export const buildPlanMessages = (request: AiChatRequest): ChatCompletionMessage[] => [
  {
    content: [
      ...
      '成功生成计划时，JSON 格式必须是：{"type":"plan_draft","plan":{"title":"7 天轻量减脂计划","goal":"轻量减脂","startDate":"YYYY-MM-DD","durationDays":7,"days":[{"dayIndex":1,"meals":[{"mealType":"breakfast","title":"...","description":"...","calories":420},{"mealType":"lunch","title":"...","description":"...","calories":650},{"mealType":"dinner","title":"...","description":"...","calories":480}],"workouts":[{"title":"...","description":"...","durationMinutes":30,"caloriesBurned":160}]}]}}。',
